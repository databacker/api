...
// BackupAttributeKey Stable OTEL span attribute key names for backup engine traces.
...
// OtelStatusCode OTEL span status code per the OpenTelemetry specification.
